...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="hidden md:min-h-[100vh] my-20 md:flex flex-col items-center py-0 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50"
    >
      <motion.h2
        style={{
...
const AriesLogo = () => {
  return (
    <svg fill="#fff" height="50px" width="50px" version="1.1" id="Capa_1" viewBox="-2.28 -2.28 27.33 27.33" stroke="#fff" style={{transform: "perspective(800px) rotateX(-35deg)", opacity: 0.85}}>
